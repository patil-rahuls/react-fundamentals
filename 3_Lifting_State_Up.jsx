...
// Earlier we used "Props" for passing data from Parent to Child component.
// But to pass data from child to parent we "Lift the state Up".

// To lift the state up, we pass a function as a prop in the child component.
